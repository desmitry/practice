def check_winners(scores, student_score):
    ...
    Args:
        ...
        student_score (int): Target score.
    Returns:
        bool: `True` if student score is in top three scores, `False` otherwise.
    """
...
check_winners([20, 48, 52, 38, 36, 13, 7, 41, 34, 24, 5, 51, 9, 14, 28], 51)
